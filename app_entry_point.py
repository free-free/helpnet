...
class Application(web.Application):
    ...
    def __init__(self):
        ...
        handlers = [
            ...
            (r'/askhelp/?', AskHelpHandler),
            (r'/gethelp/([0-9a-zA-Z]+)/?', GetHelpHandler),
            (r'/search/?', SearchHandler),
            (r'/about/?', AboutHandler), 
            (r'/document/?', DocumentHandler),
            (r'/agreement/?', AgreementHandler),
            (r'/user/?',UserHomeHandler),
            (r'/user/posthelplist/?',UserPostHelpListHandler),
            (r'/user/gethelplist/?',UserGetHelpListHandler),
            (r'/user/profile/?',UserProfileHandler),
            (r'/resource/WXQRCodeResource/get/?',WeixinQRCodeGetAPIHandler),
            (r'/resource/HelpResource/get/?',HelpGetAPIHandler),
